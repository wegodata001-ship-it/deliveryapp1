...
export default async function AdminDashboardPage({
  ...
  return (
    <div className="adm-dashboard">
      <section className="adm-dashboard-row adm-dashboard-row--top">
      ...
      <section className="adm-dashboard-row adm-dashboard-row--middle">
        <div className="adm-dash-panel adm-dash-panel--actions">
          <h2>פעולות מהירות</h2>
        ...
        <div className="adm-dash-panel adm-dash-panel--alerts">
          <h2>התראות מערכת</h2>
          {alertsTotal === 0 ? (
      ...
      <section className="adm-dashboard-row adm-dashboard-row--bottom">
        ...
        <div className="adm-dash-panel adm-dash-panel--ops">
          <h2>מצב תפעול</h2>
